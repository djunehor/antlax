...
if(!$error) {
$query = (!empty($opwd)) ? "UPDATE $user_table SET country='$country',state='$state',address='$address',phone='$phone',whatsapp='$whatsapp',fullname='$fullname',dob='$dob',password='$npwd',pemail='$pemail',bitcoin='$bitcoin' WHERE userID='$userID'" : "UPDATE $user_table SET country='$country',state='$state',address='$address',phone='$phone',whatsapp='$whatsapp',fullname='$fullname',dob='$dob',pemail='$pemail',bitcoin='$bitcoin' WHERE userID='$userID'";
